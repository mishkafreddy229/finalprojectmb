...
QUIZ_QUESTIONS = [
    {
        ...
        "options": ["Метан", "Углекислый газ (CO2)", "Кислород", "Азот"],
        "answer": 1
    },
    {
        "question": "Какой процент льда в Арктике растаял за последние 40 лет?",
        "options": ["10%", "30%", "50%", "70%"],
        "answer": 2
    },
    {
        ...
        "options": [
            "След от обуви на земле",
            "Количество парниковых газов от деятельности человека",
            "Отпечаток пальца",
            "След от автомобильных шин"
        ],
        "answer": 1
    }
]
...
def quiz_answer_callback(call):
    selected_answer = int(call.data.split("_")[-1])
    if selected_answer == 1:
        result = "✅ Правильно! CO2 - основной парниковый газ."
    elif selected_answer == 2:  
        result = "✅ Правильно! Около 50% арктического льда растаяло."
    elif selected_answer == 1:
        result = "✅ Правильно! Это выбросы парниковых газов."
    else:
        result = "❌ Неправильно. Попробуйте еще раз командой /quiz"
